    ...
    <ng-container *ngIf="kpis$ | async as kpis">
      <div class="stats shadow">
        <div class="stat">
          ...
          <div class="stat-value">{{ kpis.total | currency:'USD':true }}</div>
        </div>
        ...
        <div class="stat">
          ...
          <div class="stat-value">{{ kpis.mean | currency:'USD':true }}</div>
        </div>
        ...
        <div class="stat">
          ...
          <div class="stat-value">{{ kpis.median | currency:'USD':true }}</div>
        </div>
      </div>
    </ng-container>
  `,
